...
const finleysx_version_json_1 = require("../Defaults/finleysx-version.json");
...
const fetchLatestFinleysxVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://registry.npmjs.org/finleysx', {
            ...options,
            responseType: 'json'
        });
        ...
        return {
            version: finleysx_version_json_1.version,  
            isLatest: false,
            error
        };
    }
};
exports.fetchLatestFinleysxVersion = fetchLatestFinleysxVersion;
